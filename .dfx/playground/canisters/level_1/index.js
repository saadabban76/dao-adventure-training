...
import { idlFactory } from './level_1.did.js';
export { idlFactory } from './level_1.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LEVEL_1_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./level_1.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the level_1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./level_1.did.js")._SERVICE>}
 */
export const level_1 = createActor(canisterId);
